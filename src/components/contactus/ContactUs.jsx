...
const ContactUs = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
      ...
      <div className="contact-container" style={{ flex: 1, width: '100%' }}>
        {/* Header Section */}
          ...
          <div className="contact-columns">
            ...
            <div className="contact-details-column">
              ...
              <div className="map-container">
                <h3 style={{ color: '#9E1B47' }}>Our Location</h3>
              ...
              <form className="contact-form">
                ...
                <div className="button-group">
                  ...
                  <button
                    type="reset"
                    className="clear-btn"
                    style={{ backgroundColor: 'transparent', color: '#000', border: '1px solid #9E1B47' }}
                  >
                    Clear Form
                  </button>
                </div>
